...
urlpatterns = [
    ...
    path('get_mitigation_flows/', views.get_mitigation_flows, name='get_mitigation_flows'),
    path('reset_mitigation_stats/', views.reset_mitigation_stats, name='reset_mitigation_stats'),
